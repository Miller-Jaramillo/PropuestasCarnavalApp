<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @role('admin')
                    <x-nav-link href="{{ route('ajustar-categorias') }}" :active="request()->routeIs('ajustar-categorias')">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4"
                            style=" color: rgb(1, 120, 255);">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('admin')
                <x-responsive-nav-link href="{{ route('ajustar-categorias') }}" :active="request()->routeIs('ajustar-categorias')">
