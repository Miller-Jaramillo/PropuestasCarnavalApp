                        ...
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-5 px-4 sm:px-6">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div wire:key="{{ $propuesta->id }}" class="flex motion-safe:hover:scale-[1.05]  ">
                                        <!-- ... contenido de la propuesta ... -->

                                        <x-label wire:click="darLike({{ $propuesta->id }})"
                                            class="ml-1 text-sm font-semibold leading-7 uppercase tracking-wider cursor-pointer {{ in_array($propuesta->id, $likes) ? 'text-red-400' : 'text-sky-400' }} dark:{{ in_array($propuesta->id, $likes) ? 'text-red-400' : 'text-sky-400' }}">
                                            Me Gusta
                                        </x-label>
                                    </div>
