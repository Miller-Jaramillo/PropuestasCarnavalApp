<div wire:poll.5000ms>
    <x-label
        class="flex justify-center mt-5 dark:text-blue-500 font-semibold uppercase tracking-widest text-xs text-sky-500 dark:text-sky-500">
                            ...
                            <div class="modal-content">
                                <div class=" max-w-7xl mx-auto sm:px-6 lg:px-16 px-4 sm:px-6  ">
                                    ...
                                    <div class="mt-5 grid grid-cols-1 sm:grid-cols-1   gap-x-10 pb-5">
                                        ...
                                        <div>
                                            <x-label for=""
                                                class=" uppercase tracking-widest text-xs text-sky-500 dark:text-sky-500 ">
                                    ...
                                    <div class="mt-5 grid grid-cols-3 sm:grid-cols-3 text-center   gap-x-10  ">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="">
                                                <p
                                                    class="text-xs font-semibold leading-6 dark:text-gray-100  text-gray-900">
                                    ...
                                    <div class="mt-5 grid grid-cols-1 sm:grid-cols-1">
                                        ...
                                        <div class="mt-5  pb-5 flex justify-end">

                                            <x-button wire:click="revisarPropuesta({{ $propuestaInfo->id }})"
                                                class="bg-yellow-500 hover:bg-yellow-400 dark:bg-yellow-500 dark:hover:bg-yellow-400 tracking-widest">
                                                {{ __('Revisar') }}
                                            </x-button>
