<div wire:poll.5000ms>
    <x-label
        class="flex justify-center mt-2 dark:text-blue-500 font-semibold uppercase tracking-widest text-xs text-sky-500 dark:text-sky-500">
                        ...
                        <div class=" max-w-7xl mx-auto sm:px-6 lg:px-16 px-4 sm:px-6  ">
                            ...
                            <div class="mt-5 grid grid-cols-1 sm:grid-cols-1">
                                ...
                                <div class="mt-5  pb-5 flex justify-end">
                                    ...
                                    <x-button wire:click="revisarPropuesta({{ $propuesta->id }})"
    ...
    @else
        <div
            ...
            Los participantes todavía no han enviado propuestas.
        </div>
    @endif
