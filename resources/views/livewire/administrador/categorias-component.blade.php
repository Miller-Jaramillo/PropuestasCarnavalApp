        ...
        <div>
            ...
            <div class="mt-3">
                @if ($categoriaId)
                        ...
                        <div class="mt-5">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-5 gap-2  flex items-center">
                                <div class="col-span-3 flex items-center">
                                    ...
                                    <x-select wire:model="subcategoriaId" id="subcategoria" class="block w-full mt-3">
                    ...
                    @else
                        <div class="mt-3 border-t border-gray-200 dark:border-gray-600"></div>
                        <x-label for="" class="mt-3 text-md text-gray-500 dark:text-gray-400 ">Esta Categoria
                            aun no tiene
            ...
            @if ($confirmCategoriaDeletion)
                <div class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75">
                    <div
                        ...
                        <p>¿Estás seguro de eliminar la categoria {{ $nombre }}? Tambien se eliminaran sus
                            subcategorias</p>
                ...
                @if ($confirmSubcategoriarDeletion)
                    <div class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75">
                        <div
                            ...
                            <div class="mt-4 flex justify-end">
                                <x-button wire:click="eliminarSubcategoria({{ $confirmSubcategoriarDeletion }})"
            ...
            @if ($editarCategoria)
                <div class="mt-3">
                    <x-label class="block text-sm font-medium leading-6 text-gray-500 dark:text-gray-400">Editar
                        Categoría: {{ $categorias->where('id', $categoriaId)->first()->nombre }}</x-label>
                    <x-input type="text" wire:model="nombre" placeholder="Nuevo nombre de la categoría"
                        class="block w-full mt-1" />
            ...
            @if ($editarSubcategoria)
                <div class="mt-3">
                    <x-label class="block text-sm font-medium leading-6 text-gray-500 dark:text-gray-400">Editar
                        Subcategoría:
                        {{ $subcategorias->where('id', $subcategoriaId)->first()->nombre }}</x-label>
                    <x-input type="text" wire:model="nombre" placeholder="Nuevo nombre de la subcategoría"
                        class="block w-full mt-1" />
            ...
            <div>
                @if ($showAgregarSubcategoria)
                    <div class="mt-5">
                        ...
                        @if ($categoriaId != null)
                            <x-label class="block mt-2 font-medium leading-6 text-gray-900">Agregar Subcategoría a:
                                {{ $categorias->where('id', $categoriaId)->first()->nombre }}</x-label>
                        @endif


                        <x-input type="text" wire:model="nombre" placeholder="Nombre de la Subcategoría"
                            class="block w-full mt-1" />
                    </div>
