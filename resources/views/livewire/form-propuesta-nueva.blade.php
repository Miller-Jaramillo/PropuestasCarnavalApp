                        ...
                        <div class="border-b border-gray-100 pb-2  ">
                            <h2
                                ...
                                <p class="mt-2 text-justify block text-sm font-medium leading-6 text-emerald-400 dark:text-emerald-700 tracking-widest">
                                    Tu propuesta será enviada a los funcionarios de Corpocarnaval. Ellos la evaluarán y te notificarán
                                    por correo electrónico una vez que sea publicada. ¡Buena suerte!
                                </p>
                            ...
                            <div class="mt-3 grid grid-cols-1 sm:grid-cols-3   gap-x-10 ">
                                ...
                                <div class="sm:mt-3 mt-3">
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <x-select wire:model="categoriaId" id="categoria"
                                            wire:change="obtenerSubcategorias"
