<div wire:poll.5000ms>
                    ...
                    <div class=" max-w-7xl mx-auto sm:px-6 lg:px-16 px-4 sm:px-6 pb-5 ">
                        ...
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-5 px-4 sm:px-6">
                            ...
                            <div
                                ...
                                {{-- @if ($comentar) --}}
                                <div class="mt-2 grid grid-cols-3 sm:grid grid-cols-10 ">
                                ...
                                <div class="mt-4 pb-2">
                                    ...
                                    @foreach ($propuesta->comentarios as $comentario)
                                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-5 px-4 sm:px-6 mt-2">
                                            ...
                                            <div class="flex">
                                                <label class="ml-5 block text-xs font-medium leading-6 text-gray-400 dark:text-gray-700 tracking-widest">
                                                    responder
                                                </label>

                                                <label class="ml-2 block text-xs font-medium leading-6 text-gray-400 dark:text-gray-700 tracking-widest">
    ...
    <div>
        @if ($message)
            <div x-data="{ show: @entangle('message') }" x-show="show" x-init="setTimeout(() => { show = false; }, 1000)"
